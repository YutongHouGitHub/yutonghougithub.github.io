...
const ui_translations = {
    en: { nav: { home: 'HOME', education: 'EDUCATION', awards: 'AWARDS', experience: 'EXPERIENCE', publications: 'PUBLICATIONS', academic: 'ACADEMIC', media: 'MEDIA' }, footer: { github: 'Github', license: 'License' }, switchLanguage: 'Switch language' },
    'zh-CN': { nav: { home: '首页', education: '教育经历', awards: '获奖经历', experience: '工作经历', publications: '发表成果', academic: '学术活动', media: '媒体报道' }, footer: { github: 'Github', license: '许可证' }, switchLanguage: '切换语言' },
